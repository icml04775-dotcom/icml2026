...
class DinoVisionTransformer(nn.Module):
    ...
    def forward(self, *args, is_training=False, masks = None):
        ret = self.forward_features(*args, masks = masks)
        if is_training:
            return ret
        else:
...
def DINOv2(model_name, pretrained=True):
    from utils.dino_weights import download_variant
    ...
    if pretrained:
        try:
            ...
            state_dict = download_variant(model_name, backend="meta")
